...
A tool for computing common fairness metrics for classification and regression models build using the AI Fairness 360 library
...
- src: Source code containing the package "aif360" with tool wrapper functions
- Makefile: Build file
...
- Switch to the `tests/context/<interface>` directory and then use
    ...
    - The image name will be `aif360-tool` (`aif360-tool-grpc` if using grpc interface)
