...
from tests.integration.test_scikit_logreg_model import scikit_logreg_model_workflow_compose


@pytest.fixture(scope="module")
def call_create_grpc_docker_context_scikit_logreg_model(
...
@pytest.mark.grpc
def test_create_scikit_logreg_model_container_filematch(
    call_create_grpc_docker_context_scikit_logreg_model, node_context_dir
):
    """Test a scikit_logreg_model image context created by the barebone via file matching

    Args:
        call_create_grpc_docker_context_scikit_logreg_model: A pytest fixture that calls the barebone
        create_grpc_docker_context function
    """

    src, dest = call_create_grpc_docker_context_scikit_logreg_model
...
@pytest.mark.scikit_logreg_model
@pytest.mark.grpc
def test_create_scikit_logreg_model_docker(
    ...
    scikit_logreg_model_workflow_compose(
        (
            node_test_dir,
            node_context_dir,
            orch_context_dir,
