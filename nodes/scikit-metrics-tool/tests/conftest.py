...
def workflow_inputs(node_test_dir):
    ...
    pred_file = os.path.join(test_data_dir, "pred_labels.json")
    true_file = os.path.join(test_data_dir, "true_labels.json")
    return [pred_file, true_file]
