...
NODE_NAME = "uncertainty-toolbox-metrics"
...
def workflow_inputs(node_test_dir):
    ...
    predictions_file = os.path.join(test_data_dir, "predictions.arrow")
    labels_file = os.path.join(test_data_dir, "labels.arrow")
    config_file = os.path.join(test_data_dir, "config_A.json")
    return [predictions_file, labels_file, config_file]
